...
INSERT OR IGNORE INTO user (id, email, name, email_verified, role, username, created_at, updated_at) VALUES
...
-- Create some POIs
-- INSERT OR IGNORE INTO pois (poi_type, metadata, location_geojson, created_at, updated_at) VALUES

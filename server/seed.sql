...
INSERT OR IGNORE INTO profiles (id, name, avatar_url) VALUES
(1, 'Alice', 'https://example.com/avatars/alice.png');

-- Insert avoidance area if it doesn't exist
INSERT OR IGNORE INTO avoidance_areas (user_id, name, boundary_geojson) VALUES (
	1,
	'Downtown Austin',

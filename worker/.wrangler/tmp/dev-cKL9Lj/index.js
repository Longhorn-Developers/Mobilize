...
// .wrangler/tmp/bundle-Qy3LSw/checked-fetch.js
...
var jwtMiddleware = jwt({
  secret: /* @__PURE__ */ __name((c) => c.env.JWT_SECRET, "secret")
});
app7.get("/", (c) => {
  return c.json({
...
app7.use("/avoidance-areas/*", jwtMiddleware);
app7.use("/pois/*", jwtMiddleware);
...
// .wrangler/tmp/bundle-Qy3LSw/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Qy3LSw/middleware-loader.entry.ts
